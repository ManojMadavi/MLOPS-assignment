...
# Load Iris dataset
df = pd.read_csv("C:/Users/manoj/OneDrive/Desktop/MLOPS-assignments/Docker_Assignment/Iris.csv")

# Ensure the static/images directory exists
if not os.path.exists("static/images"):
    os.makedirs("static/images")

# Mount static files for images, CSS, JavaScript
app.mount("/static", StaticFiles(directory="Docker_Assignment/static"), name="static")

# Set up templates
templates = Jinja2Templates(directory="Docker_Assignment/templates")
...
async def filter_iris_data(request: Request, species: str, page: int = Query(1, ge=1)):
    ...
    # Create feature visualization for the selected species
